...
report via the repository's
[private vulnerability reporting form](https://github.com/agent-zero-plugins/agent-zero-plugin-development-testkit/security/advisories/new)
(also used for conduct reports) or by contacting the repository maintainers.
